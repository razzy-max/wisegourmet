...
router.patch('/:id/staff/verify-pickup-pin', protect, authorize('admin', 'branch_admin', 'staff'), verifySelfPickupPin);
router.get('/', protect, authorize('admin', 'branch_admin', 'staff'), getAllOrders);
router.patch('/:id/assign-rider', protect, authorize('admin', 'branch_admin', 'staff'), assignRider);
...
router.patch('/:id/status', protect, authorize('admin', 'branch_admin', 'staff', 'rider'), updateOrderStatus);
...
router.get('/:id', protect, authorize('customer', 'admin', 'branch_admin', 'staff', 'rider', 'support'), getOrder);
